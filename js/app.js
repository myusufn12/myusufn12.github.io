$(document).ready(function () {
  ...
  var waypoint = new Waypoint({
    ...
    handler: function () {
      ...
      p[1].setAttribute("style", "width:100%;transition:1.5s all;");
      p[2].setAttribute("style", "width:25%;transition:1.7s all;");
      p[3].setAttribute("style", "width:25%;transition:2s all;");
  ...
  var typed = new Typed(".element", {
    strings: ["Muhammad Yusuf", "a Web Developer", "a Web Designer"],
    smartBackspace: true,
    typeSpeed: 100,
    backSpeed: 100,
    loop: true,
